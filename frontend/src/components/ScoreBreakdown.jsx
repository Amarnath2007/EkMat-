    ...
    <div className="bg-slate-900/90 rounded-xl p-4 border border-slate-800 space-y-4">
      <div className="flex items-center justify-between pb-3 border-b border-slate-800">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm font-medium text-slate-200">Confidence Scoring Engine</span>
        </div>
        <div className="text-right">
          <span className="text-2xl font-bold tracking-tight text-white">{wtPct}%</span>
          <span className="text-xs text-slate-400 block">Weighted Confidence</span>
        </div>
      </div>
      ...
      <div className="space-y-3 text-xs">
        ...
        <div>
          <div className="flex justify-between items-center mb-1">
            <span className="flex items-center text-slate-300 font-medium">
              <Brain className="w-3.5 h-3.5 mr-1.5 text-indigo-400" />
              Semantic Embedding (SBERT all-MiniLM-L6-v2)
            </span>
            <span className="text-slate-400 font-semibold">{semPct}% <span className="text-[10px] text-slate-500 font-normal">(50% wt)</span></span>
          </div>
        ...
        <div>
          <div className="flex justify-between items-center mb-1">
            <span className="flex items-center text-slate-300 font-medium">
              <AlignLeft className="w-3.5 h-3.5 mr-1.5 text-sky-400" />
              Lexical Similarity (RapidFuzz Token Sort/Set)
            </span>
            <span className="text-slate-400 font-semibold">{fuzPct}% <span className="text-[10px] text-slate-500 font-normal">(30% wt)</span></span>
          </div>
          <div className="w-full h-2 bg-slate-800 rounded-full overflow-hidden">
            <div
        ...
        <div>
          <div className="flex justify-between items-center mb-1">
            ...
            <span className="text-slate-400 font-semibold">{attrPct}% <span className="text-[10px] text-slate-500 font-normal">(20% wt)</span></span>
          </div>
          <div className="w-full h-2 bg-slate-800 rounded-full overflow-hidden">
            <div
              className={`h-full rounded-full transition-all duration-500 ${
                attrPct === 0 ? 'bg-rose-500' : 'bg-gradient-to-r from-emerald-500 to-teal-500'
              }`}
      ...
      <div className="bg-slate-950/60 rounded-lg p-2.5 border border-slate-800/80 text-[11px] text-slate-400">
        <span className="font-semibold text-slate-300">Routing Policy: </span>
        <code className="text-slate-300 bg-slate-800/80 px-1 py-0.5 rounded text-[10px]">
